...
cam_label.grid(row=1, column=3)
mic_label.grid(row=1, column=4)
...
# an ON/OFF button for the PWM light controller. Additional hardware may be required to implement this function. A Raspberry Pi GPIO line, or the I2C
# GPIO expander may be used.
